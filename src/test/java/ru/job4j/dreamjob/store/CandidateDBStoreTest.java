...
public class CandidateDBStoreTest {
    ...
    public void whenCreateCandidate() {
        ...
        Candidate candidate = new Candidate(0, "Candidate name", "Description", new City(1, "Москва"));
    ...
    public void whenFindAllCandidate() {
        CandidateDBStore store = new CandidateDBStore(new Main().loadPool());
        Candidate candidate1 = new Candidate(0, "Candidate name1", "Description1", new City(1, "Москва"));
        Candidate candidate2 = new Candidate(0, "Candidate name2", "Description2", new City(1, "Москва"));
        Candidate candidate3 = new Candidate(0, "Candidate name3", "Description3", new City(1, "Москва"));
